...
**
****************************************************************************/
#ifndef UIMOBILEMAIN_H
#define UIMOBILEMAIN_H
...
class UIMobileMain : public QMainWindow
{
    Q_OBJECT

public:
    UIMobileMain( QWidget* parent = 0 );
    virtual ~UIMobileMain();
