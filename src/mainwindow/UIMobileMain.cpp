...
UIMobileMain::UIMobileMain( QWidget* parent )
    : QMainWindow( parent ),
        d( new UIMainPrivate( this ) )
{
}

UIMobileMain::~UIMobileMain()
{
}

void UIMobileMain::changeEvent( QEvent* event )
{
...
void UIMobileMain::showEvent( QShowEvent* event )
{
...
void UIMobileMain::closeEvent( QCloseEvent* event )
{
